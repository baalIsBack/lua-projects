...
function Self:init(args)
  ...
  self.button_up = require 'engine.gui.Button':new{x=0, y=-self.h/2 + 8, w=16, h=16, visibleAndActive=true}
  ...
  self.button_down = require 'engine.gui.Button':new{x=0, y=self.h/2 - 8, w=16, h=16, visibleAndActive=true}
