...
function Self:getSender()
  return MAILS[self.prototype_id].sender
end

function Self:getSubject()
  return MAILS[self.prototype_id].subject
end

function Self:getContent()
  return MAILS[self.prototype_id].content
end

function Self:getExpectedReply()
  return MAILS[self.prototype_id].expected_reply
end

function Self:getTargetQuest()
  return MAILS[self.prototype_id].target_quests
end

function Self:getSourceQuests()
  return MAILS[self.prototype_id].source_quests
end
...
function Self:onRead(main)
  MAILS[self.prototype_id].onRead(self, main)
end

function Self:onReply(main, text)
  MAILS[self.prototype_id].onReply(self, main, text)
end
...
function Self:isRedeemed()
  return self.redeems >= MAILS[self.prototype_id].redeemable
end

function Self:isRedeemedForNextQuest()
  return self.redeems >= MAILS[self.prototype_id].redeems_required_for_next_quest
end
